    ...
    >
      <div id='in-view' className='flex flex-col gap-4'>
        ...
        <p className='description text-white font-ubuntu md:text-xl max-w-2xl'>
          Hi, I&apos;m Nick, a 18 student deeply passionate about programming
          for the past 2.5 years. With 4 years of coding experience, I bring a
          blend of creativity and technical proficiency to every project.
          Outside the digital realm, I adore{' '}
